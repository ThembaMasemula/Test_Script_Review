...
public class AddNewCohort1 extends BaseTest {
  ...
  public void test_BeforeSetup() throws Exception {
    try {
      initialiseWeb();
  ...
  public void test_LoginSuccessfactors() throws Exception {
    WebDriver driver = getWebdriver();
    webFunctions.LoginSuccessfactors(driver, test);
  }
  ...
  public void test_NavigateToLMS() throws Exception {
    WebDriver driver = getWebdriver();
    webFunctions.NavigateToLMS(driver, test);
  }
  ...
  public void test_NavigateToCohorts() throws Exception {
    WebDriver driver = getWebdriver();
    webFunctions.NavigateToCohorts(driver, test);
  }
  ...
  public void test_AddNewCohort() throws Exception {
    WebDriver driver = getWebdriver();
    webFunctions.AddNewCohort(driver, test);
  }
}
