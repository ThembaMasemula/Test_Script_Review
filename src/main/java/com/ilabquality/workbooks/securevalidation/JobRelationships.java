...
public class JobRelationships extends BaseTestSecureValidation {
	...
	private void securityViewHistory() throws Exception {
		System.out.println("Verify History");
		fw.waitForLoadPage();
		employeeProfilePage.clickHistoryJobRelationships();
	...
	private void securityAddData() throws Exception {
		...
		fw.waitForLoadPage();
		employeeProfilePage.clickEditJobRelationships();
