...
public class ContingentWorker extends BaseTestSecureValidation {
	...
	private void securityViewHistory() throws Exception {
		System.out.println("Verify History");
		fw.waitForLoadPage();
		employeeProfilePage.clickHistoryContingentWorker();
	...
	private void securityAddData() throws Exception {
		...
		fw.waitForLoadPage();
		employeeProfilePage.clickEditContingentWorker();
