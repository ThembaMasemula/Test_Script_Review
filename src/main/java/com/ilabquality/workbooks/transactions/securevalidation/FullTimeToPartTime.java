...
public class FullTimeToPartTime extends BaseTestSecureValidationHRTransactions {
	...
	public static void beforeEach() throws EncryptedDocumentException, IOException {
		...
		if (!parametersOk) {
			parameters = data("Full Time To Part Time");
			parametersOk = true;
		}
		// System.out.println("OK: " + parametersOk);
	}
	...
	public void test() throws Exception {
		...
		try {
			...
			fw.timeout(1000);
			changeJobCompensationInfoPage.waitUntilLoadingDisappear();
			changeJobCompensationInfoPage.setIsFulltimeEmployee("N");
			changeJobCompensationInfoPage.waitUntilLoadingDisappear();
			// fw.getFullScreenshot();
