...
public class LateralMoveWPayChange extends BaseTestSecureValidationHRTransactions {
	...
	public static void beforeEach() throws EncryptedDocumentException, IOException {
		...
		if (!parametersOk) {
			parameters = data("Lateral move w. pay change");
			parametersOk = true;
		}
		// System.out.println("OK: " + parametersOk);
	}
	...
	public void test() throws Exception {
		...
		try {
			...
			// OPTIONAL
			try {
				changeJobCompensationInfoPage.waitUntilLoadingDisappear(1);
