...
public class InvImmigration extends BaseTestSecureValidationHRTransactions {
	...
	public static void beforeEach() throws EncryptedDocumentException, IOException {
		...
		if (!parametersOk) {
			parameters = data("Inv Immigration");
			parametersOk = true;
		}
		// System.out.println("OK: " + parametersOk);
	}
	...
	public void test() throws Exception {
		try {
			...
			terminationReason = "Inv Termination - Immigration";
